...
SELECT id, nombre,
  CASE WHEN estado IN ('1','t','true') THEN true ELSE false END AS estado,
  id_departamento
FROM (VALUES
	(1,'Abriaquí',true,5),
	(2,'Acacías',true,50),
	...
	(10,'Aguadas',true,17),
	(11,'Aguazul',true,85),
	(12,'Agustín Codazzi',true,20),
	(13,'Aipe',true,41),
	(14,'Albania',true,18),
	(15,'Albania',true,44),
	(16,'Albania',true,68),
	(17,'Albán',true,25),
	(18,'Albán (San José)',true,52),
	(19,'Alcalá',true,76),
	...
	(26,'Altamira',true,41),
	(27,'Alto Baudó (Pie de Pato)',true,27),
	(28,'Altos del Rosario',true,13),
	(29,'Alvarado',true,73),
	(30,'Amagá',true,5),
	(31,'Amalfi',true,5),
	(32,'Ambalema',true,73),
	...
	(61,'Argelia',true,19),
	(62,'Argelia',true,76),
	(63,'Ariguaní (El Difícil)',true,47),
	(64,'Arjona',true,13),
	(65,'Armenia',true,5),
	(66,'Armenia',true,63),
	(67,'Armero (Guayabal)',true,73),
	...
	(1090,'Zapayán (PUNTA DE PIEDRAS)',true,47),
	(1091,'Zaragoza',true,5),
	(1092,'Zarzal',true,76),
	(1093,'Zetaquirá',true,15),
	(1094,'Zipacón',true,25),
	(1095,'Zipaquirá',true,25),
	(1096,'Zona Bananera (PRADO - SEVILLA)',true,47),
	(1097,'Ábrego',true,54),
	(1098,'Íquira',true,41),
	(1099,'Úmbita',true,15),
	(1100,'Útica',true,25)
) AS t(id int, nombre text, estado text, id_departamento int);